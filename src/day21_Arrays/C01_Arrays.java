...
public class C01_Arrays {
    public static void main(String[] args) {
        ...
        //araryi nasil deklare ederiz
        //data turu araryin ismi ve koseli parantez yazarak arra deklare edilir
    ...
    // ass'ng mevburimidir
        ...
        int arr7[]=new int [5];  // java icinde 5 tane default deger olan bir array olusturur
                                // [0,0,0,0,0] intgerein default degeri 0 oldugu icin boyle cikar
